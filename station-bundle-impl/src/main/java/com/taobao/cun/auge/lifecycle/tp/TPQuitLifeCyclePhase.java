...
public class TPQuitLifeCyclePhase extends BaseLifeCyclePhase {
	...
	public void thawAccountMoney(LifeCyclePhaseContext context) {
		PartnerInstanceDto partnerInstanceDto = context.getPartnerInstance();
	...
	@PhaseMeta(descr="退出异步任务：关闭菜鸟物流、支付宝标、关闭优盟")
	public void executeQuitAyncTask(LifeCyclePhaseContext context) {
		PartnerInstanceDto partnerInstanceDto = context.getPartnerInstance();
