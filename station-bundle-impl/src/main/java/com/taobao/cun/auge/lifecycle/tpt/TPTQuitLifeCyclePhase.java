 ...
 */
@Component
@Phase(type="TPT",event=StateMachineEvent.QUIT_EVENT,desc="镇小二退出中服务节点")
public class TPTQuitLifeCyclePhase extends AbstractLifeCyclePhase{
	...
	@Override
	@PhaseStepMeta(descr="更新镇小二实例状态到退出中")
