 ...
 */
@Component
@Phase(type="TPT",event=StateMachineEvent.SERVICING_EVENT,desc="镇小二停业中服务节点")
public class TPTServicingLifeCyclePhase extends AbstractLifeCyclePhase{
	...
	@Override
	@PhaseStepMeta(descr="更新镇小二站点信息到服务中")
	...
	@Override
	@PhaseStepMeta(descr="更新镇小二LifeCycleItems")
