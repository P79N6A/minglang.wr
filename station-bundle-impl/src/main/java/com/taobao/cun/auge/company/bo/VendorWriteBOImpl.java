...
public class VendorWriteBOImpl implements VendorWriteBO {
    ...
    public Long addVendor(CuntaoServiceVendorDto cuntaoServiceVendorDto) {
        ResultDO<BaseUserDO> vendorUserDOresult = uicReadServiceClient.getBaseUserByUserId(cuntaoServiceVendorDto.getTaobaoUserId());
    ...
    public Long addNewVendor(CuntaoServiceVendorDto cuntaoServiceVendorDto) {
        ...
        return cuntaoServiceVendor.getId();
    }
