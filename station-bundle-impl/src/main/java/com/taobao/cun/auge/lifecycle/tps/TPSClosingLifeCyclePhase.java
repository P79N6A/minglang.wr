 ...
 */
@Component
@Phase(type="TPS",event=StateMachineEvent.CLOSING_EVENT,desc="村小二停业中服务节点")
public class TPSClosingLifeCyclePhase extends BaseLifeCyclePhase {
