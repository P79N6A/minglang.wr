...
public class InspectionStationStatus {
	...
	public static final String DECORATING ="DEOCRATING";//装修中
	
	public static final String SERVICING = "SERVICING";//服务中
	
	public static final String CLOSING = "CLOSING"; //停业中
	
	public static final String CLOSED = "CLOSED"; //已停业
