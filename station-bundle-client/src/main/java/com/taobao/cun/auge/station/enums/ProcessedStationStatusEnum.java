...
public enum ProcessedStationStatusEnum {
	...
	// 开业流程
	SUMITTED("SUMITTED", "待确认协议"), CONFIRMED("CONFIRMED", "待缴纳保证金"),DECORATING("DECORATING","已缴纳保证金"),UNPAY_DECORATE("UNPAY_DECORATE", "待缴纳装修金"),UNPAY_COURSE("UNPAY_COURSE", "待缴纳培训金"), UNSIGNED("UNSIGNED", "待培训签到"),DEC_FEEDING_BACK("DEC_FEEDING_BACK","待装修反馈"), DEC_WAIT_AUDIT("DEC_WAIT_AUDIT", "装修反馈待审核"), SERVICING("SERVICING",
			"已开业"),
	// // 退出流程
