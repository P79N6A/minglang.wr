...
public enum ProcessedStationStatusEnum {
	...
	// 开业流程
	SUMITTED("SUMITTED", "待签约人确认"), CONFIRMED("CONFIRMED", "待缴纳保证金"), UNPAY_COURSE("UNPAY_COURSE", "待购买培训基金"), UNPAY_DECORATE("UNPAY_DECORATE", "待缴纳装修基金"), UNSIGNED("UNSIGNED", "待培训签到"), DEC_WAIT_AUDIT("DEC_WAIT_AUDIT", "装修反馈待审核"), SERVICING("SERVICING",
			"已完成开业"),
	// // 退出流程
