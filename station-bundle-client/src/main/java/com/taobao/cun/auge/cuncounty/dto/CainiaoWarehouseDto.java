...
public class CainiaoWarehouseDto {
	/**
	 * 县仓ID
	 */
	protected Long id;
	 ...
	 * 状态
	 */
	private CainiaoWarehouseStateEnum state;
	public Long getId() {
		return id;
	}
	...
	public CainiaoWarehouseStateEnum getState() {
		return state;
	}
	public void setState(CainiaoWarehouseStateEnum state) {
		this.state = state;
	}
}
